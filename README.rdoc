...
Uses RSpec, Shoulda, RR, and Factory Girl for testing.

HAML and ERB can both be used for view templates.
...
rails new name_of_your_new_rails_app --template http://github.com/boochtek/rails-template/raw/master/rails-template.rb
